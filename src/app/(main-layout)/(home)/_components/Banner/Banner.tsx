  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden  py-10">
      ...
      <div className="relative z-10 ">
        <CustomContainer>
          <div className="flex flex-col items-start justify-between  gap-5 h-full space-y-[85%] sm:space-y-[45%] md:space-y-[35%] lg:space-y-5">
            <div className="text-white space-y-[5%] md:space-y-[20%] pt-[20%] md:pt-[5%]">
              <h1 className="text-2xl md:text-6xl lg:text-[115px] font-bold text-left uppercase md:tracking-[5px]">
